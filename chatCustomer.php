...
<?php
session_start();
//sender is tradesman     .. receiver is tradesman
//tradesman page
...
<head>
  ...
  <body class="">
    ...
    <div class="text-center my-3" id="hiring_status_box">
      <button
        type="submit"
        class="btn col-8 col-md-8 col-lg-6"
        id="button_register"
      >
        <span class="text-white fw-bold"
          >Tradesman accepted your hiring.......!</span
        >
      </button>
    </div>
    <!-- ----------------------  -->
        ...
        <div id="tradesman_box" class="row mb-4 fw-bold">
          <div id="box1" class="row col-12 col-md-6 col-lg-4 m-1 d-md-flex my-3">
            <div id="profile_tradesman" class="col-12 col-md-3 col-lg-12">
              <img src="abinesh.JPG" class="" id="image_detail" />
            </div>
          ...
          >
            <div class="pb-2">
              Service Amount : <span id="pay_amount">Rs300.00</span>
            </div>
            <button type="paynow" class="btn px-5" id="button_paynow">
